...
# transport ids exactly as Colosseum routes them (bare / us. / global. prefixes)
MODELS=(
  ...
  "zai.glm-5"                                      # GLM-5
  "us.amazon.nova-lite-v1:0"                       # Nova Lite (us. profile)
  "global.amazon.nova-2-lite-v1:0"                 # Nova 2 Lite (global. profile)
  "us.anthropic.claude-3-7-sonnet-20250219-v1:0"   # Claude 3.7 Sonnet (us. profile)
